...
Citizen.CreateThread(function()
    while true do
        ...
        if IsPlayerConnected then
            QBCore.Functions.TriggerCallback('ps_lib:server:haspickaxe', function(cb)
                if cb then
                    has_pickaxe = true
                else
                    has_pickaxe = false
    ...
    while true do
        ...
        for k in pairs(Stones_smelt) do
              ...
              if dist <= 1.0 and not NearMarker then
                 ...
                 if IsControlJustPressed(0,38) then
                    TriggerServerEvent('ps_lib:stones:smelt')
                 end
              end
        end
        ...
        for k in pairs(Rocks_smelt) do
              ...
              if dist <= 1.0 and not NearMarker then
                 ...
                 NearMarker = true
                 if IsControlJustPressed(0,38) then
                    TriggerServerEvent('ps_lib:rocks:smelt')
                 end
              end
        end
        ...
        for k in pairs(Stones_sell_pos) do
              ...
              if dist <= 1.0 and not NearMarker then
                 ...
                 NearMarker = true
                 if IsControlJustPressed(0,38) then
                    TriggerServerEvent('ps_lib:stones:sell')
                 end
              end
        end
        ...
        for k in pairs(Rocks_sell_pos) do
              ...
              if dist <= 1.0 and not NearMarker then
                 ...
                 NearMarker = true
                 if IsControlJustPressed(0,38) then
                    TriggerServerEvent('ps_lib:rocks:sell')
                 end
              end
        end
    ...
    Citizen.CreateThread(function()
        ...
        while impacts < 5 do
            ...
            if impacts == 5 then
               ...
               TriggerServerEvent('ps_lib:stones:find')
               mineActive = false
               break
            end
        end
    ...
    Citizen.CreateThread(function()
        ...
        while impacts < 5 do
            ...
            if impacts == 5 then
               impacts = 0
               DeleteEntity(pickaxe)
               TriggerServerEvent('ps_lib:rocks:find')
               mineActive = false
               break
            end
        end
