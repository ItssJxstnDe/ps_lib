...
-- Pickaxe check --
QBCore.Functions.CreateCallback('ps_lib:server:haspickaxe', function(source, cb)
...
RegisterNetEvent('ps_lib:stones:find', function()
  local _source = source
  local xPlayer = QBCore.Functions.GetPlayer(_source)
...
RegisterNetEvent('ps_lib:rocks:find', function()
  local _source = source
  local xPlayer = QBCore.Functions.GetPlayer(_source)
...
RegisterNetEvent('ps_lib:stones:smelt', function()
    local _source = source
    local xPlayer = QBCore.Functions.GetPlayer(_source)
...
RegisterNetEvent('ps_lib:rocks:smelt', function()
    local _source = source
    local xPlayer = QBCore.Functions.GetPlayer(_source)
...
RegisterNetEvent('ps_lib:stones:sell', function()
    local _source = source
    local xPlayer = QBCore.Functions.GetPlayer(_source)
...
RegisterNetEvent('ps_lib:rocks:sell', function()
    local _source = source
    local xPlayer = QBCore.Functions.GetPlayer(_source)
